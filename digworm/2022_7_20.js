;(() => {
  ...
  ;(function () { //from https://github.com/olibaron/raf-polyfill/blob/master/raf.js
    for (
      var lastTime = 0,
  ...
  const isMobileOrTablet = (window.mobileAndTabletCheck = function () { //from https://stackoverflow.com/a/11381730
      let check = false
      var ua
      return (
  ...
  updateDisplay(fixedJoystickCbEl, isMobileOrTablet)
  updateDisplay(kbMovementCbEl, !isMobileOrTablet)
  isMobileOrTablet &&
  ...
  isMobileOrTablet && _0x1bb119.classList.add('fullsize-shop')
  ...
  function _0x13d5e7() {
    _0x19da0e =
      ...
      (isMobileOrTablet && !isMobile ? 1.6 : 1)
